...
def MusicTaggerCRNN(weights='msd', input_tensor=None):
    ...
    x = ELU()(x)
    x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), name='pool2', trainable=False)(x)
    ...
    x = ELU()(x)
    x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), name='pool3', trainable=False)(x)
    ...
    x = ELU()(x)
    x = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), name='pool4', trainable=False)(x)
